...
function SignUp() {
    return (
        <section className='flex flex-row justify-center items-center bg-[aliceblue] mx-auto w-fit rounded-2xl fixed z-10 top-48'>
            ...
            <section className='px-10 gap-10 flex flex-col'>
                ...
                <div className='flex flex-col justify-center items-center gap-2'>
                    ...
                    <button className='font-Arial font-bold text-xl flex justify-between text-black border-slate-300 border-2 rounded-xl w-[100%] items-center px-10 py-3' > <img className='w-[1.7rem] ' src="https://www.svgrepo.com/show/14478/email.svg" alt="" />Continue with google</button>
            ...
            <button><img className='w-8 absolute top-5 right-5' src="https://cdn-icons-png.flaticon.com/512/106/106830.png" alt="" /></button>
