...
function Hero() {
    return (
        <div className=" mx-auto overflow-x-hidden flex flex-col items-center gap-10">
            ...
            <Link to="/jobs">
                <button className='hidden max-xl:block px-[1.5rem] py-[.25rem] rounded-xl border-[1px] border-slate-500 hover:bg-[#29282a] hover:border-white'>Find Jobs</button>
            </Link>
            <div className=" mx-auto max-w-4xl pt-5 md:pt-15"><video muted loop playsInline autoPlay src={video} className="w-full rounded-[10px]"></video></div>
